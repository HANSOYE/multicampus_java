...
public class ArrayTest3 {
	...
	public static void main(String[] args) {
		...
		int y[] = {10, 20};
		int tmp[]; //선언
		//x,y 값을 tmp 변수를 사용하여 서로 바꿔보세요 (swap)
		//for 루프 이용해서 x,y 에 저장된 값 출력해보기
		tmp = x;
		x=  y;
		y = tmp;
		...
		System.out.println("**************");
		//확장 for 루프, 개선된 for 루프, for each루프...
		 ...
		 * 		실행문;
		 * }
		 * 알아서 자료구조의 크기(length)만큼 반복문 돌면서 자료구조에 저장된 값을 변수에 할당한다
		 */
