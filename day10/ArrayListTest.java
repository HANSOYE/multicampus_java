...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		...
		List<Integer> arrList2 = Arrays.asList(8, 1, 90, 0);
		...
		//Collections.sort() 메서드를 이용해서 정렬 : 오름차숨
		//Collections.reverseOrder() : 내림차순
		Collections.sort(arrList2);
		System.out.println("=========arrList2 정렬 이후========");
		for(Integer val: arrList2) {
			System.out.println(val);
		}
		
		//List<E> arr = new ArrayList<E>(); ==> 동적인 컬렉션 생성 (데이터 추가/삭제 가능함)
		//List<E> arr = Arrays.asList(E, E, E, ...); ==> 정적인 컬렉션 (데이터 추가/삭제 불가능함)
